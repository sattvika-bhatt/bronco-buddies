...
Run the script (run `make migrate MSG="your migration message" ENV={main|dev|local}` if you changed db/models.py):
...
Serve the app locally (run `make migrate MSG="your migration message" ENV={main|dev|local}` if you changed db/models.py):
